...
class MouldBindTask {
  ...
  MouldBindTask.fromJson(dynamic json) {
    if (json['data'] != null) {
      _data = [];
      json['data'].forEach((v) {
        _data?.add(MouldTaskItem.fromJson(v));
      });
    }
...
/// distributionTimeStamp : 1657645437000
/// finishedTime : "2022-07-13 00:33:28"
/// mouldList : [{"assetBindTaskId":0,"assetLifespan":"4.542","assetNo":"PO124250-1657645404-F","bindLabels":["XP705_0"],"bindStatus":0,"bindStatusText":"待绑定","cavityPhoto":{"docComments":"","documentName":"","downloadType":"","fileSize":0,"fileSuffix":"","fullPath":""},"distributionTime":"2022-07-13 01:03:57","labelReplaceTaskId":46,"labelType":0,"lat":0.0,"lng":0.0,"manufactureUnits":"","moldName":"机油压力表","moldNo":"65832191","mouldFixedassetId":0,"nameplatePhoto":{"docComments":"","documentName":"xxx铭牌图","downloadType":"url","fileSize":0,"fileSuffix":"","fullPath":"2022-8-9/testimage_0VcOfkAl2wP.jpg"},"overallPhoto":{"docComments":"","documentName":"","downloadType":"","fileSize":0,"fileSuffix":"","fullPath":""},"poNo":"","remark":"上次出问题再绑","taskNo":"BQT1657645437","toolingName":"机油压力表模具","toolingSize":"2300*3000*5000","toolingType":"F","toolingWeight":"3.1","usedUnits":"","vehicle":"387"}]
/// poNo : ""
/// taskNo : "BQT1657645437"
/// taskType : 1
/// totalMoulds : 1
...
class MouldTaskItem {
  MouldTaskItem({
    ...
    _mouldList = mouldList;
    _poNo = poNo;
    _taskNo = taskNo;
    _taskType = taskType;
    _totalMoulds = totalMoulds;
  }

  MouldTaskItem.fromJson(dynamic json) {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (_mouldList != null) {
      map['mouldList'] = _mouldList?.map((v) => v.toJson()).toList();
    }
    map['poNo'] = _poNo;
    map['taskNo'] = _taskNo;
...
class MouldList {
  MouldList({
    ...
    _moldName = moldName;
    _moldNo = moldNo;
    _mouldFixedassetId = mouldFixedassetId;
    _nameplatePhoto = nameplatePhoto;
    _overallPhoto = overallPhoto;
    _poNo = poNo;
    _remark = remark;
    _taskNo = taskNo;
    _toolingName = toolingName;
    _toolingSize = toolingSize;
    _toolingType = toolingType;
    _toolingWeight = toolingWeight;
    _usedUnits = usedUnits;
    _vehicle = vehicle;
  }

  MouldList.fromJson(dynamic json) {
    ...
    _remark = json['remark'];
    _taskNo = json['taskNo'];
    _toolingName = json['toolingName'];
    _toolingSize = json['toolingSize'];
    _toolingType = json['toolingType'];
    _toolingWeight = json['toolingWeight'];
    _usedUnits = json['usedUnits'];
    _vehicle = json['vehicle'];
  }
  int? _assetBindTaskId;
  String? _assetLifespan;
  String? _assetNo;
  ...
  String? get taskNo => _taskNo;
  String? get toolingName => _toolingName;
  String? get toolingSize => _toolingSize;
  String? get toolingType => _toolingType;
  String? get toolingWeight => _toolingWeight;
  String? get usedUnits => _usedUnits;
  String? get vehicle => _vehicle;

  Map<String, dynamic> toJson() {
    final map = <String, dynamic>{};
    map['assetBindTaskId'] = _assetBindTaskId;
    map['assetLifespan'] = _assetLifespan;
    ...
    map['moldName'] = _moldName;
    map['moldNo'] = _moldNo;
    map['mouldFixedassetId'] = _mouldFixedassetId;
    ...
    map['remark'] = _remark;
    map['taskNo'] = _taskNo;
    map['toolingName'] = _toolingName;
    map['toolingSize'] = _toolingSize;
    map['toolingType'] = _toolingType;
    map['toolingWeight'] = _toolingWeight;
    map['usedUnits'] = _usedUnits;
